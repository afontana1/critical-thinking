...
**Big question:**
How do we responsibly infer what happened in the past (and why), using incomplete, biased, and fragile evidence?
...
* What are historians trying to do: recover facts, interpret meaning, explain change, or build usable pasts?
* Can history be “objective,” and what would that mean?
* What makes historical knowledge different from memory, myth, journalism, or propaganda?

**Sub-units**

1. **History as inquiry (not a timeline)**
...
* What are the reusable “moves” historians make when reasoning from evidence?
* How do we keep analysis from collapsing into storytelling-without-checks?
...
3. **A procedure view: “how to do history”**
   ...
   * A stepwise historical procedure: question → sources → criticism → interpretation → argument.
4. **Historical consciousness**

   * How “the past” shows up in identity, politics, and moral imagination.
...
* How do you tell whether a source is any good?
* What’s the difference between “a source exists” and “a claim is warranted”?

**Sub-units**

1. **Primary vs. secondary sources**

   * And the tricky cases: memoirs, newspapers, oral history, artifacts, datasets.
2. **External criticism (authenticity, provenance, preservation)**

   * Who made it? when? how transmitted? what’s missing?
3. **Internal criticism (meaning, reliability, bias, genre)**

   * What does the author mean? what incentives shape testimony?
4. **Corroboration and triangulation**

   * Independent support; converging lines of evidence.
5. **Your “Critical Questions for Historical Sources” as a rubric**

   * Fallibility, first-hand vs. hearsay, contemporaneity, corroboration, plausibility constraints, relics, preservation, translation issues, bias, motivation-explication.
...
* What does it mean to “interpret” a text, image, or artifact responsibly?
* How does context constrain meaning (and how can it mislead)?
...
3. **Perspective-taking without credulity**

   * Understanding is not endorsement.
4. **Reading against the grain**

   * What a source reveals unintentionally; silences and exclusions.
...
* What counts as a good historical explanation?
* How do we reason about causes when we can’t run experiments?

**Sub-units**

1. **Multi-causality and causal webs**
...
* How do historians’ assumptions shape what they “see”?
* What changed from “scientific objectivity” to postmodern challenges?
...
* When should we count things? When should we interpret texts?
* How do we avoid “physics-envy” while still doing rigorous measurement?
...
* Why do false historical narratives spread so well?
* How do memory, identity, and media shape historical belief?

**Sub-units**

1. **Public history vs. academic history**

   * Different goals, different constraints, overlapping responsibilities.
2. **Pop history: incentives and failure modes**
...
* What does a good historical research project look like end-to-end?
* How do you present uncertainty honestly while still making a claim?

**Sub-units**

1. **Question formation**

   * Scope, feasibility, and “answerability” given available sources.
2. **Research design**

   * What sources exist? where? what biases? what gaps?
3. **Building an argument**

   * Claims, warrants, evidence, counterevidence; writing that signals confidence levels.
4. **Peer review and revision**

   * Stress-testing your causal story and your source handling.
...
1. **Source Criticism Dossier (mini-archive)**

   * Pick a historical claim; assemble 8–12 sources (mixed types); apply your “Critical Questions” rubric; write a credibility and preservation/translation audit.
...
[1]: https://en.wikipedia.org/wiki/Historical_method "Historical method (overview)"
[2]: https://www.umass.edu/wsp/method/history/outline/ "UMass Outline of Historical Procedure"
[3]: https://www.historians.org/ "American Historical Association"
[4]: https://historicalthinking.ca/ "The Historical Thinking Project"
[5]: https://historicalthinking.ca/books "Historical Thinking Project: books (Big Six)"
[6]: https://garrigus2302.wordpress.com/2007/02/16/the-5-cs-of-historical-thinking/ "Five Cs (teaching-oriented framing)"
[7]: https://plato.stanford.edu/entries/history/ "SEP: Philosophy of History"
[8]: https://plato.stanford.edu/entries/hermeneutics/ "SEP: Hermeneutics"
[9]: https://global.oup.com/academic/product/the-landscape-of-history-9780195171570 "Gaddis: The Landscape of History (OUP)"
[10]: https://www.penguinrandomhouse.com/books/24386/what-is-history-by-edward-hallett-carr/ "Carr: What Is History? (Vintage)"
[11]: https://global.oup.com/academic/product/the-idea-of-history-9780192853066 "Collingwood: The Idea of History (OUP)"
[12]: https://www.weslpress.org/9780819567666/historiography-in-the-twentieth-century/ "Iggers: Historiography in the Twentieth Century (Wesleyan)"
[13]: https://press.uchicago.edu/ucp/books/book/chicago/T/bo27214768.html "Gallagher: Telling It Like It Wasn’t (UChicago Press)"
[14]: https://press.uchicago.edu/ucp/books/book/chicago/T/bo17212779.html "Maza: Thinking About History (UChicago Press)"
[15]: https://www.jstor.org/stable/j.ctv1pdrrc9 "Schrag: The Princeton Guide to Historical Research (JSTOR/PUP)"
[16]: https://www.penguinrandomhouse.com/books/14924/the-historians-craft-by-marc-bloch/ "Bloch: The Historian’s Craft (Vintage)"
[17]: https://www.cornellpress.cornell.edu/book/9780801485602/from-reliable-sources/ "Howell & Prevenier: From Reliable Sources (Cornell)"
[18]: https://www.psupress.org/books/titles/0-271-01474-1.html "Walton: Arguments from Ignorance (Penn State University Press)"
[19]: https://www.routledge.com/Argumentation-Schemes-for-Presumptive-Reasoning/Walton/p/book/9780805820720 "Walton: Argumentation Schemes (Routledge)"
[20]: https://amstudies.stanford.edu/publications/historical-thinking-and-other-unnatural-acts-charting-future-teaching-past "Wineburg: Historical Thinking and Other Unnatural Acts (Stanford listing)"
[21]: https://escholarship.org/uc/cliodynamics "Cliodynamics journal (eScholarship)"
[22]: https://peterturchin.com/cliodynamics-history-as-science/ "Turchin: Cliodynamics overview"
[23]: https://seshat-global-history-databank.github.io/seshat/ "Seshat: Global History Databank documentation"
[24]: https://digitalcommons.chapman.edu/religious_studies_articles/6/ "Turchin (2020): Introduction to Seshat (article)"
[25]: https://csh.ac.at/daniel-hoyer/ "Daniel Hoyer profile (CSH)"
[26]: https://www.so-dy.org/ "So-Dy: Societal Dynamics"
[27]: https://www.cliometrics.org/about/what-is-cliometrics/ "Cliometrics Society: definition"
[28]: https://eh.net/encyclopedia/cliometrics/ "EH.net: Cliometrics encyclopedia entry"
[29]: https://methods.sagepub.com/book/mono/content-analysis-4e/toc "Krippendorff: Content Analysis (SAGE Methods)"
[30]: https://www.tandfonline.com/doi/abs/10.1191/1478088706qp063oa "Braun & Clarke (2006): Thematic analysis paper"
[31]: https://en.wikipedia.org/wiki/Misinformation_effect "Misinformation effect (overview)"
