...
**Assumed background / bridge from Course 1**

Students are coming in having thought about:

* Epistemic virtues/vices, bullshit, ignorance, and extremism
* Language, metaphor, framing, definitions, and conceptual engineering
* Social epistemology, testimony, and epistemic injustice
* Cognitive biases, AOT, and metacognition

This course now **makes arguments the central object of study**: their structure, patterns, and evaluation, including both informal and formal tools.

**By the end, students should be able to:**

* Distinguish different *types of argument* (analogical, abductive, practical, presumptive, evidential, appeals to authority, etc.) and see them as *schemes* with associated critical questions.
* Use the **Toulmin model**, **argument mapping**, and **Walton-style argumentation schemes** to analyze real arguments. ([Cambridge University Press & Assessment][1])
* Explain the nature of **non-monotonic / defeasible reasoning** and how it differs from deductive validity. ([Stanford Encyclopedia of Philosophy][2])
* Diagnose **fallacies** not just as named errors but as *systematic failures* of support, scheme misuse, or abuse of conversational norms. ([Amazon][3])
* Connect everyday argument patterns to **scientific reasoning**, **legal reasoning**, **policy deliberation**, and **interpretive argumentation**.
* See how **evidence** interacts with hypotheses and stories, and be ready to go deeper in Course 3 on evidence and evidential reasoning. ([Stanford Encyclopedia of Philosophy][4])
...
1. **Arguments, reasons, and conclusions**

   * Revisit but sharpen: argument vs. assertion vs. explanation vs. description.
...
* Stephen Toulmin, *The Uses of Argument*. ([Cambridge University Press & Assessment][1])
...
* When are analogies illuminating vs. misleading?
* How does **precedent** work in law and policy, and what does that tell us about analogical reasoning?

**Sub-units**

1. **Basic structure of analogical arguments**

   * Classic scheme:

     * Case A has properties P, Q, R.
     * Case B has P, Q, R.
     * A has property S, so (probably) B has S.
   * Distinguish analogies used to *explain* from analogies used to *argue*.

2. **Story similarity and argument from analogy**

   * Walton’s work on **story schemes** and similarity: arguments from analogy often compare *stories* or episodes, not just lists of features. ([SSRN][9])
   * Similarity is structured by what is *salient* given the dispute (goals, causal structure, norms), not just superficial resemblance.

3. **Precedent and case-based reasoning**

   * Legal reasoning as paradigmatic analogical reasoning: *stare decisis* and “treat like cases alike.” ([Learning Research & Development Center][10])
   * Case-based reasoning in AI & Law: indexing cases, measuring similarity, and arguing from past cases to new ones. ([iamaeg.net][11])
   * Use of examples in moral and political argument: paradigm cases, slippery precedents.

4. **Shortfalls and critical questions**

   * Critical questions for analogy and precedent:

     * Are the compared cases *relevantly* similar?
     * Are there important disanalogies?
     * Is there a better, competing analogy?
   * Common pathologies: cherry-picked analogies, “abusive” historical analogies (e.g., everything becomes “like Nazi Germany”), one-off anecdotes treated as precedents.

5. **Applications**

   * Analogical arguments in bioethics, technology regulation, and social policy (e.g., “Is X *like* medical treatment or enhancement?”).
   * Exercises: students reconstruct analogical arguments from op-eds and court cases using mapping + schemes.
...
1. **Peirce’s “abduction”**
   ...
   * Peirce’s triad: deduction, induction, abduction. ([Stanford Encyclopedia of Philosophy][13])
   * Abduction as forming explanatory hypotheses—“inference to the *possible* cause.”

2. **Inference to the Best Explanation (IBE)**

   * Peter Lipton’s IBE: from data to the hypothesis that, if true, would best explain those data. ([Routledge][14])
   * Criteria for “best”: simplicity, coherence with background knowledge, explanatory power, unification, etc.
   * Differences and connections between Peircean abduction and Lipton’s IBE.

3. **Abductive patterns and schemes**

   * Walton-style schemes for argument from evidence to hypothesis, with critical questions (e.g., are there alternative explanations? is the hypothesis independently plausible?). ([windsor.scholarsportal.info][15])
   * Abduction as a *pattern of reasoning* that shows up in science, diagnosis, and everyday puzzles.

4. **Plausibility structures and hypothesis spaces**

   * “Plausibility structures” as the background of what we can even *imagine* as a candidate explanation (bridge to Course 1 on framing, narratives, and echo chambers).
   * Hypothesis spaces and a gentle, non-mathematical intro to **Bayesian confirmation**:

     * Evidence updates degrees of belief in different hypotheses. ([Stanford Encyclopedia of Philosophy][4])
     * Many hypotheses can fit the same data (underdetermination).
     * Total evidence: why cherry-picked data mislead.

5. **Critical questions for abduction**

   * Are we considering enough alternatives? (problem of unconceived alternatives).
...
1. **Practical reasoning schemes**

   * Walton’s basic practical reasoning scheme:
...
2. **Decision theory, very lightly**
   ...
   * Decision theory / rational choice: maximizing expected utility given preferences and beliefs, in conditions of risk and uncertainty. ([Wikipedia][17])
   * How decision theory abstracts practical reasoning patterns.
   * Points of contact and tension between normative decision theory and messy real-life deliberation (cognitive limits from Course 1).

3. **Values, ends, and “oughts”**

   * Practical reasoning as inescapably *value-laden*: we reason about what is good, better, worse, fair, etc.
   * Aristotle, endoxa, and arguments about what’s choiceworthy or virtuous (bridge to virtue epistemology). ([Wikipedia][18])
   * Distinguish: instrumental “means–ends” arguments vs. arguments about *which ends* to adopt.

4. **Critical questions and limitations**

   * Are the stated goals legitimate? Are they shared?
   * Does action A *really* promote G, or are there hidden side effects, opportunity costs, or value conflicts?
   * Is the agent’s information adequate? Are there better options not considered?

5. **Policy and public reasoning**

   * Practical reasoning in public policy: cost–benefit analysis, precautionary principle, appeals to rights and justice.
   * Exercises: map practical arguments in policy debates (e.g., climate policy, public health, surveillance) in Toulmin + scheme format.
...
1. **Presumptive reasoning**
   ...
   * Walton’s account: presumptions as defeasible, context-dependent starting points that shift burdens of proof. ([Routledge][8])
   * Presumptive reasoning as essential to everyday and legal argument (we can’t prove everything from scratch).
   * Godden and others on presumption as a “negative” logic—reasonable in absence of defeating evidence. ([PhilArchive][22])

2. **Assumptions vs. presuppositions**

   * **Assumptions** as explicit or implicit premises used “for the sake of argument.”
...
4. **Critical questions**
   ...
   * Are we smuggling controversial claims in as presuppositions (“When did you stop doing X?”)?
...
* How does *evidence* function in arguments?
* What does it mean to say that evidence “supports” a hypothesis or story?
* How do stories and arguments interact in legal and scientific contexts?
...
2. **Story schemes and evidence**

   * Bex and others: hybrid **stories-and-arguments** models—legal fact-finding requires both argument schemes and narrative coherence. ([PMC][25])
   * “Story schemes” as patterns for constructing plausible narratives from fragments of evidence.

3. **Multiple hypotheses and underdetermination**

   * Evidence can be compatible with multiple hypotheses; link back to Unit 3 (abduction, IBE).
   * The role of background assumptions and prior probabilities in shaping which explanation seems “best.”

4. **What counts as evidence? (very general)**

   * Distinguish: raw data, observations, reports, experimental results, testimonies, statistical patterns.
   * Bridge to Course 3: reliability of measurement, causal inference, confounding, and social dimensions of evidence will be developed later.

**Core readings**

* Douglas Walton, selections on arguments from evidence and sign. ([windsor.scholarsportal.info][15])
* Floris Bex, “Story Schemes for Argumentation about the Facts of a Crime” and “The Hybrid Theory of Stories and Arguments.” ([ai.rug.nl][26])
* A short, accessible piece on evidence and confirmation (e.g., a chapter from a philosophy of science intro or SEP “Confirmation”). ([Stanford Encyclopedia of Philosophy][4])
...
* When is it reasonable to defer to experts?
* What makes an appeal to authority legitimate vs. fallacious?
* How do we evaluate expert disagreement?

**Sub-units**

1. **Scheme for argument from expert opinion**

   * Walton’s canonical scheme for appeal to expert opinion (source E is an expert in domain D, says A, so (presumably) A). ([psupress.org][27])
   * Associated critical questions: credentials, domain match, consensus, bias, track record, etc.

2. **The expert identification problem**

   * Wagemans and others on reconstructing and evaluating arguments from expert opinion. ([SpringerLink][28])
   * How media, institutions, and social networks signal “expertise” (bridge to Course 1’s social epistemology and epistemic injustice).

3. **Expert disagreement and lay audiences**

   * How non-experts should reason when experts disagree: strategies other than cherry-picking the expert who agrees with your prior.
   * Interaction with trust, epistemic vigilance, and echo chambers (explicitly tie back to Course 1 Unit 6).

4. **Fallacious appeals to authority**

   * Misapplied domain, fake or bought expertise, celebrity authority, and pseudo-experts.
   * Exercises: diagnose authority appeals in ads, political debates, and online discourse using the scheme + questions.
...
* What are fallacies, *really*?
* How do they relate to argument schemes, conversational norms, and cognitive biases?
* How can we go beyond fallacy-spotting to serious diagnosis and repair?

**Sub-units**

1. **Families of fallacies**

   * Formal vs. informal; fallacies of relevance, ambiguity, presumption, weak induction, etc. ([Amazon][3])
   * Connect to Course 1: many fallacies track cognitive biases and social pressures rather than sheer stupidity.

2. **Fallacies as *misused schemes***

   * Straw man, ad hominem, slippery slope, appeal to popularity, etc., interpreted as distortions of otherwise legitimate schemes.
   * For each, identify:
...
* What does formal logic contribute to the study of argument?
* What are the limits of formalization for real-world reasoning?
* What are “non-classical logics,” and why do they exist?

**Sub-units**

1. **Propositional logic basics**

   * Propositions, connectives, truth tables, valid forms (modus ponens, modus tollens, etc.).
   * Relationship to formal fallacies (affirming the consequent, denying the antecedent, etc.).

2. **Rules of inference and proofs**

   * Natural deduction or Fitch-style proofs at a basic level; how they represent chains of valid inference.
   * Emphasize: this is a *tool* for certain tasks, not the whole of reasoning.

3. **Defeasible reasoning vs. monotonic logic**

   * Reconnect with Unit 1: classical logic is monotonic; real reasoning is often non-monotonic and defeasible.
   * Introduce non-monotonic logic as a family of formalisms for defeasible reasoning. ([Stanford Encyclopedia of Philosophy][2])

4. **Very brief tour of non-classical logics**

   * Mention (at high altitude): modal, deontic, relevant, paraconsistent, default logics, etc., and what problems they address (obligation, knowledge, inconsistency, defaults). ([Horty][30])
   * Aim: give students a sense that “logic” is plural and context-sensitive, without going technical.

5. **Limits and misapplications**

   * Dangers of forcing messy ethical, political, or legal disputes into overly sanitized logical forms.
   * When formalization clarifies vs. when it distorts.
...
* **Argument Mapping & Scheme Analysis Project**

  Students choose a substantive real-world issue (e.g., public health policy, climate litigation, AI regulation, campus speech controversies) and:

  * Collect a small corpus of argumentative texts (op-eds, policy briefs, legal opinions, debates).
  * Produce detailed **argument maps** (Toulmin-style + mapping software if available).
  * Classify key arguments using **Walton-style schemes** (analogy, practical reasoning, expert opinion, evidence, etc.) and apply corresponding **critical questions**.
  * Diagnose fallacies and *scheme misuses* rather than just naming fallacy labels.
  * Reflect on:

    * Where reasoning is **defeasible** and how new evidence or counterarguments would shift conclusions.
    * How **evidence** is used to support stories and hypotheses (bridge to Course 3).
    * How **language, framing, and conceptual choices** inherited from Course 1 shape what counts as a good argument here.
...
[3]: https://www.amazon.com/Informal-Logical-Fallacies-Brief-Guide/dp/0761854339 "Informal Logical Fallacies: A Brief Guide"
[4]: https://plato.stanford.edu/entries/confirmation/ "Confirmation - Stanford Encyclopedia of Philosophy"
[5]: https://en.wikipedia.org/wiki/Argumentation_theory "Argumentation theory"
[6]: https://www.cambridge.org/core/books/argumentation-schemes/9AE7E4E6ABDE690565442B2BD516A8B6 "Argumentation Schemes"
[7]: https://timvangelder.com/2009/02/17/what-is-argument-mapping/ "What is argument mapping? - Tim van Gelder"
[8]: https://www.routledge.com/Argumentation-Schemes-for-Presumptive-Reasoning/Walton/p/book/9780805820720 "Argumentation Schemes for Presumptive Reasoning"
[9]: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2189845&utm_source=chatgpt.com "Douglas Walton - Story Similarity in Arguments from Analogy"
[10]: https://www.lrdc.pitt.edu/ashley/ashleypubs/ashleyailcbrarticle.pdf "Case-based reasoning and its implications for legal expert ..."
[11]: https://iamaeg.net/files/267A598B-5C9B-4F1A-8500-BDFCB5FAF823.pdf "Artificial Intelligence and Legal Analytics"
[12]: https://folk.idi.ntnu.no/agnar/CBR%20papers/KER/14.%20CBR%20and%20law%20%28Rissland%2C%20Ashley%2C%20%26%20Branting%29.pdf "Case-based reasoning and law"
[13]: https://plato.stanford.edu/entries/abduction/peirce.html "Peirce on Abduction - Stanford Encyclopedia of Philosophy"
[14]: https://www.routledge.com/Inference-to-the-Best-Explanation/Lipton/p/book/9780415242035 "Inference to the Best Explanation - 2nd Edition - Peter Lipton"
[15]: https://windsor.scholarsportal.info/omp/index.php/wsia/catalog/view/106/106/1086 "PDF view of the file 11-Walton.pdf"
[16]: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3322824&utm_source=chatgpt.com "Practical Reasoning: A Modular Approach"
[17]: https://en.wikipedia.org/wiki/Decision_theory "Decision theory"
[18]: https://en.wikipedia.org/wiki/Topics_%28Aristotle%29 "Topics (Aristotle)"
[19]: https://www.researchgate.net/publication/221622842_Explanations_and_Arguments_Based_on_Practical_Reasoning "Explanations and Arguments Based on Practical Reasoning."
[20]: https://informallogic.ca/index.php/informal_logic/article/view/466/435 "Is Practical Reasoning Presumptive? - Informal Logic"
[21]: https://web.stanford.edu/~jdlevin/Econ%20202/Choice%20Theory.pdf "Introduction to Choice Theory"
[22]: https://philarchive.org/archive/GODATO-3 "A Theory of Presumption for Everyday Argumentation"
[23]: https://plato.stanford.edu/entries/presupposition/ "Presupposition - Stanford Encyclopedia of Philosophy"
[24]: https://www.cambridge.org/core/books/burden-of-proof-presumption-and-argumentation/introduction-to-basic-concepts-and-methods/1F992AA2918E04A65DA2572CE6B7FE82 "Introduction to Basic Concepts and Methods (Chapter 1)"
[25]: https://pmc.ncbi.nlm.nih.gov/articles/PMC7687106/ "The Hybrid Theory of Stories and Arguments Applied to the ..."
[26]: https://www.ai.rug.nl/~verheij/publications/pdf/aaai2010.pdf "Story Schemes for Argumentation about the Facts of a Crime"
[27]: https://www.psupress.org/books/titles/0-271-01694-9.html?srsltid=AfmBOorWIB3WvDgTQ9b7Gyq3V97nHvEkqSl4spp8iXcKfb8XdcGq_FV1&utm_source=chatgpt.com "Appeal to Expert Opinion: Arguments from Authority By ..."
[28]: https://link.springer.com/article/10.1007/s10503-011-9225-8 "The Assessment of Argumentation from Expert Opinion"
[29]: https://www.criticalthinking.org/data/pages/25/2e51737bb044ed99a88bdc1220fe8cb660f7687377bed.pdf "INFORMAL FALLACIES------"
[30]: https://www.horty.umiacs.io/articles/1993-deontic.pdf "Deontic Logic as Founded on Nonmonotonic Logic - John Horty"
[31]: https://iccm-conference.neocities.org/2020/papers/Contribution_247_final.pdf "The Power of Nonmonotonic Logics to Predict the ..."
[32]: https://iep.utm.edu/leg-herm/ "Legal Hermeneutics"
[33]: https://www.jstor.org/stable/j.ctvpj74xx "New Rhetoric, The: A Treatise on Argumentation"
[34]: https://www.psupress.org/books/titles/0-271-01474-1.html?srsltid=AfmBOoqF7_4CsQ27koXOCd8gRXsBcKsueSz8MVHfb3UrbQDE9ZnN_J0d&utm_source=chatgpt.com "Arguments from Ignorance By Douglas Walton"
[35]: https://mechanism.ucsd.edu/bill/teaching/F12/cs200/Readings/Nersessian.cognitivebasisofmodel-basedreasoninginscience.2002.pdf "7 The cognitive basis of model-based reasoning in science"
